...
export default function ExerciseCard(props) {
  ...
  return (
    ...
    bg-slate-950 sm:flex-wrap'>
        <div className='flex flex-col sm:flex-row ssm:items-center sm:flex-wrap gap-x-4'>
            ...
            max-w-full text-lg sm:text-xl md:text-2xl flex-1 sm:text-center'>{exercise.name.replaceAll("_", " ")}
            </h2>
            ...
            {['reps', 'rest', 'tempo'].map(info => {
                return(
                    ...
                    border-solid border-slate-900 w-full'>
                        <h3 className='capitalize text-slate-400 text-sm'>{info === 'raps' ? `${exercise.unit}` : info}
